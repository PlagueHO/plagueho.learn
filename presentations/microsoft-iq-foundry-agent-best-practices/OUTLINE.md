...
- **Speaker Notes**: "Tool reliability is an engineering discipline, not a prompt trick. Treat tool definitions like API contracts. Watch out for tool proliferation — the anti-pattern of wrapping every endpoint as a separate tool."
- **Duration**: ~2.5 min
...
| 2026-04-02 | Added tool proliferation vs intelligent tools concept to slide 8 | Key anti-pattern: wrapping every REST endpoint as a tool kills selection accuracy |
